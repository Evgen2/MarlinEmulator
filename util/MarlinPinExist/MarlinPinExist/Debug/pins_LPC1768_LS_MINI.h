...
#define	LED1_PIN    _IPIN(2,9)   //   P2_9 SERV1 D11
#define     USBTX  P0_2
#define     USBRX  P0_3
...
#define LEVEL_0_PIN       0   // Analog Input
#define LEVEL_1_PIN       1   // Analog Input
...
//P0.25 - t2  //D40
#define USE_TMP03
#define TMP03_0_PIN	_IPIN(2,2)
#define TMP03_1_PIN	_IPIN(0,25)

//P1.20 P1.23
#define USE_QEI

#define HEATER_PIN   _IPIN(2,6)  // P2_6 (bed) = RAMPS_D8_PIN
#define RED_LASER_PIN      _IPIN(0,22)	// P3_26 D40
#define ZATVOR_PIN   _IPIN(2,7)   
