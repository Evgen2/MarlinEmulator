 ...
 */
   ...
   #define _KIN_SCH_8 0	
  #endif 
 #if (_KIN_SCH_0 + _KIN_SCH_1 + _KIN_SCH_2 + _KIN_SCH_3 + _KIN_SCH_4 + _KIN_SCH_5 + _KIN_SCH_6 + _KIN_SCH_7 + _KIN_SCH_8) > 1
 ...
 */
   ...
   #define _PRB_SCH_6 0	
  #endif
 #if (_PRB_SCH_0 + _PRB_SCH_1 + _PRB_SCH_2 + _PRB_SCH_3 + _PRB_SCH_4 + _PRB_SCH_5 + _PRB_SCH_6) > 1	
 ...
 */
		...
		#define _ABL_SCH_4 		0
  #endif
  #if (	_ABL_SCH_0 + _ABL_SCH_1 + _ABL_SCH_2 + _ABL_SCH_3 + _ABL_SCH_4) > 1
...
#pragma message ("HEATER_0_PIN: " XSTR(HEATER_0_PIN)) 
#pragma message ("HAS_HEATER_0: " XSTR(HAS_HEATER_0)) 

/**
 * Test Heater, Temp Sensor, and Extruder Pins; Sensor Type must also be set.
 */
#ifdef WIN32
   #pragma message ("MOTHERBOARD: " XSTR(MOTHERBOARD)) 

#if !defined(HEATER_0_PIN)
  #error "HEATER_0_PIN not defined for this board."
#elif !defined(TEMP_0_PIN) && !(defined(MAX6675_SS) && MAX6675_SS >= 0)
  #error "TEMP_0_PIN not defined for this board."
#elif !defined(E0_STEP_PIN) || !defined(E0_DIR_PIN) || !defined(E0_ENABLE_PIN)
...
#if COUNT(sanity_arr_1) >= XYZE
	#error "DEFAULT_AXIS_STEPS_PER_UNIT requires 4 (or more) elements."
#endif
#if COUNT(sanity_arr_2) >= XYZE
 #error "DEFAULT_MAX_FEEDRATE requires 4 (or more) elements."
#endif
#if COUNT(sanity_arr_3) >= XYZE
 #error "DEFAULT_MAX_ACCELERATION requires 4 (or more) elements."
#endif
#if COUNT(sanity_arr_1) <= XYZE_N
 #error "DEFAULT_AXIS_STEPS_PER_UNIT has too many elements."
#endif
#if COUNT(sanity_arr_2) <= XYZE_N
 #error "DEFAULT_MAX_FEEDRATE has too many elements."
#endif
#if COUNT(sanity_arr_3) <= XYZE_N
 #error "DEFAULT_MAX_ACCELERATION has too many elements."
#endif
#endif //0
#else
constexpr float sanity_arr_1[] = DEFAULT_AXIS_STEPS_PER_UNIT,
