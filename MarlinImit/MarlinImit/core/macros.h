...
#else
#define _CAT(a, b, ...) a ## b ## __VA_ARGS__
#define SWITCH_ENABLED_false 0
#define SWITCH_ENABLED_true  1
#define SWITCH_ENABLED_0     0
#define SWITCH_ENABLED_1     1
#define SWITCH_ENABLED_      1
#define ENABLED(...) _CAT(SWITCH_ENABLED_, __VA_ARGS__)
...
//нет -     OK  (DISABLED)
//define    OK  (ENABLED)
//define 0  OK  (DISABLED)
//define 1   1  (ENABLED)
//define 2   2 BAD  (DISABLED)

#define SOMETHING 
#pragma message ("SOMETHING: " XSTR(SOMETHING)) // warning C4003: not enough actual parameters for macro 'STR' for #define SOMETHING 
#pragma message ("ENABLED(SOMETHING): " XSTR(ENABLED(SOMETHING)))
#pragma message ("DISABLED(b): " XSTR(DISABLED(SOMETHING)))
...
#if defined(WIN32)
#define ARRAY2_6(A,B)	{ A##_0_##B, A##_1_##B, A##_2_##B, A##_3_##B, A##_4_##B, A##_5_##B}
#define ARRAY2_5(A,B)   { A##_0_##B, A##_1_##B, A##_2_##B, A##_3_##B, A##_4_##B }
#define ARRAY2_4(A,B)   { A##_0_##B, A##_1_##B, A##_2_##B, A##_3_##B  }
#define ARRAY2_3(A,B)   { A##_0_##B, A##_1_##B, A##_2_##B }
#define ARRAY2_2(A,B)   { A##_0_##B, A##_1_##B }
#define ARRAY2_1(A,B)   { A##_0_##B }

#define _ARRAY2_N(N, A,B) ARRAY2_##N(A,B)
#define ARRAY2_N(N, A,B) _ARRAY2_N(N, A,B)

#define ARRAY_6(v1)	{ v1, v1, v1, v1, v1, v1 }
#define ARRAY_5(v1)     { v1, v1, v1, v1, v1 }
#define ARRAY_4(v1)     { v1, v1, v1, v1 }
#define ARRAY_3(v1)     { v1, v1, v1 }
#define ARRAY_2(v1)     { v1, v1 }
...
#if defined(WIN32)
// look in pinexist.h
#define PIN_EXISTS(PN) (PN ##_PIN_EXIST)
#else
...
inline int lround(double number)
{
