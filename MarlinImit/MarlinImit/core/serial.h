...
extern const char errormagic[] PROGMEM;
...
#if NUM_SERIAL > 1
  #define SERIAL_CHAR_P(p,x)          (WITHIN(p, 0, NUM_SERIAL-1) ? (p == 0 ? MYSERIAL0.write_0(x) : MYSERIAL1.write_0(x)) : SERIAL_CHAR(x))
  ...
  #define SERIAL_CHAR(x)              (MYSERIAL0.write_0(x), MYSERIAL1.write_0(x))
...
//??  #define SERIAL_PRINTF_P(p,args...)  SERIAL_PRINTF(args)
  ...
  #define SERIAL_CHAR(x)              MYSERIAL0.write_0(x)
