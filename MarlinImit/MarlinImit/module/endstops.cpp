...
void Endstops::update() {
  ...
  #else
    #define X_MOVE_TEST stepper.current_block && stepper.current_block->steps[X_AXIS] > 0
  ...
  #else
    #define Y_MOVE_TEST stepper.current_block && stepper.current_block->steps[Y_AXIS] > 0
  ...
  #else
    #define Z_MOVE_TEST stepper.current_block && stepper.current_block->steps[Z_AXIS] > 0
